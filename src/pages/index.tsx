    ...
    return (
        <>
            <Head>
                ...
                <meta charSet="utf-8" />
                <meta name="description" content="Learn Indian/Hindustani classical music from a Govt registered center
                ...
                <meta property="og:description" content="In covid, mental health is big issue from which we are still
