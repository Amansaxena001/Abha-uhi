    ...
    return (
        <div className={styles.outerContainer}>
            ...
            <div className={styles.container__2}>
                ...
                <div>
                    <h2>
                        Graduate with a degree <br /> equivalent to <strong>B.A</strong>
                    </h2>
                    <p>
                        After successfull completion of the course i'e 6 years, a degree certificate called <strong>Prabhakar</strong> is issued by Prayag
